...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#030712] relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-amber-950/10 blur-[120px] pointer-events-none" />

      {/* LEFT SIDE - Branding and agro aesthetic details */}
      <div className="hidden md:flex md:w-1/2 p-12 lg:p-16 flex-col justify-between relative bg-slate-950/40 border-r border-slate-900">
